...
| レベル | 目的 | 含まれるもの |
|--------|------|------------|
| **無料** | 体験＋方法論 | 30-adoption/try/の制御OS＋10-framework/の構造解説＋FM40件概要＋15件の公開成果ページ（6件詳細＋9件概要）＋代表SVG図 |
...
Phase1 / Phase2 の記載は境界設計を明確にするためのものです。無料リポジトリ単体でも、試行・反証・転用が完結する状態を維持します。
