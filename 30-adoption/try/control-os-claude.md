...
- Single file analysis/summary → Gemini/OpenAI API via Bash (97% = Claude token reduction via external API delegation [observed: single environment, N undisclosed])
