# 品質システム設計（公開構造版）
Language: [English version](../../10-framework/05-quality-system.md)
...
> *注: `[external monitoring hook]`, `非公開データストア` 等は安全な公開のために伏字化しています。各公開区分の提供範囲は [SCOPE-MATRIX-ja.md](../SCOPE-MATRIX-ja.md) を参照。*
...
#1-5は形式を確認。#6は意味を確認。6つ全てが通過して初めて「深い作業」。
