...
| 省略系でユーザー反論が発生 | [internal database table]に記録+パターン登録 |
...
*注: `[external monitoring hook]`, `[internal database table]` 等は安全な公開のために伏字化しています。各ティアの提供範囲は [SCOPE-MATRIX-ja.md](../../SCOPE-MATRIX-ja.md) を参照。*

| 条件 | 学習データカテゴリ |
|---|---|
| 検証合格+[external monitoring hook]合格+5セット完備 | 高品質データ（優先蓄積） |
